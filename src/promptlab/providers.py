...
class OllamaProvider(Provider):
    ...
    def __init__(self, host: str | None = None, model: str = "qwen3:14b"):
    ...
    def generate(self, prompt: str, **kwargs) -> GenerateResult:
        ...
        try:
            ...
            # qwen3 may put text in "thinking" field instead of "response"
...
ALL_PROVIDERS: list[type[Provider]] = [OllamaProvider, AnthropicProvider, OpenAIProvider]
...
def get_provider(name: str) -> Provider:
    """Get a provider by name. Raises ValueError if not found."""
    for cls in ALL_PROVIDERS:
        if cls.name == name:
            return cls()
